                    ...
                    <nav className="flex justify-between bg-gray-900 text-white w-screen">
                        <div className="px-5 xl:px-12 py-6 flex w-full items-center">
                            ...
                            <ul className="hidden md:flex px-4 mx-auto font-semibold font-heading space-x-12">
                                ...
                                <Link className="hover:text-gray-200" href="/friends">Friends</Link>
                                <Link className="hover:text-gray-200" href="/groups">Groups</Link>
                            </ul>
                            {/* <!-- Header Icons --> */}
                            <div className="hidden xl:flex items-center space-x-5 items-center">
                                {!token ? <>
                                    <ul className="hidden md:flex px-4 mx-auto font-semibold font-heading space-x-12">
                                        <Link className="hover:text-gray-200" href="/login">Login</Link>
                                        <Link className="hover:text-gray-200" href="/register">Register</Link>
                                    </ul>
                                </> :
                                    <>
